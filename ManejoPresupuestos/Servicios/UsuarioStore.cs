...
namespace ManejoPresupuestos.Servicios
{
    public class UsuarioStore : IUserStore<Usuario>, IUserEmailStore<Usuario>, IUserPasswordStore<Usuario>
    {
        ...
        {
            user.Id = await usuarios.CrearUsuario(user);
        ...
        {
            return await usuarios.BuscarUsuarioPorEmail(normalizedEmail);
        }
        ...
        {
            return await usuarios.BuscarUsuarioPorEmail(normalizedUserName);
        }
